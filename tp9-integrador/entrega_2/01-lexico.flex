...
<YYINITIAL> {
	...
	":="                {anuncio("ASIGNACION");return new Symbol(Simbolo.ASIGNA, yycolumn, yyline);}
    "=="                {anuncio"IGUAL");return new Symbol(Simbolo.IGUAL, yycolumn, yyline, new String(yytext()));}
    "<>"                {anuncio("DISTINTO");return new Symbol(Simbolo.DISTINTO, yycolumn, yyline, new String(yytext()));} 
    "<"                 {anuncio("MENOR");return new Symbol(Simbolo.MENOR, yycolumn, yyline, new String(yytext()));}
    "<="                {anuncio("MENOR_IGUAL");return new Symbol(Simbolo.MENOR_IGUAL, yycolumn, yyline, new String(yytext()));}
    ">"                 {anuncio("MAYOR");return new Symbol(Simbolo.MAYOR, yycolumn, yyline, new String(yytext()));}
    ">="                {anuncio("MAYOR_IGUAL");return new Symbol(Simbolo.MAYOR_IGUAL, yycolumn, yyline, new String(yytext()));}
    "+"                 {anuncio("SUMA");return new Symbol(Simbolo.SUMA, yycolumn, yyline, new String(yytext()));}
    "-"                 {anuncio("RESTA");return new Symbol(Simbolo.RESTA, yycolumn, yyline, new String(yytext()));}
    "/"                 {anuncio("DIVIDE");return new Symbol(Simbolo.DIVIDE, yycolumn, yyline, new String(yytext()));}
    "*"                 {anuncio("MULTIPLICA");return new Symbol(Simbolo.MULTIPLICA, yycolumn, yyline, new String(yytext()));}
    "("                 {anuncio("PAR_ABRE");return new Symbol(Simbolo.PAR_ABRE, yycolumn, yyline);}
	")"                 {anuncio("PAR_CIERRA");return new Symbol(Simbolo.PAR_CIERRA, yycolumn, yyline);}
    "{"                 {anuncio("LLAVE_ABRE");return new Symbol(Simbolo.LLAVE_ABRE, yycolumn, yyline);}
    "}"                 {anuncio("LLAVE_CIERRA");return new Symbol(Simbolo.LLAVE_CIERRA, yycolumn, yyline);}  
    "["                 {anuncio("COR_ABRE");return new Symbol(Simbolo.COR_ABRE, yycolumn, yyline);}  
    "]"                 {anuncio("COR_CIERRA");return new Symbol(Simbolo.COR_CIERRA, yycolumn, yyline);}  
    ";"                 {anuncio("PUNTO_COMA");return new Symbol(Simbolo.PUNTO_COMA, yycolumn, yyline);}
    ","                 {anuncio("COMA");return new Symbol(Simbolo.COMA, yycolumn, yyline);}
    "\""				{anuncio("COMILLA");return new Symbol(Simbolo.COMILLA, yycolumn, yyline);}
    "\'"				{anuncio("APOSTROFE");return new Symbol(Simbolo.APOSTROFE, yycolumn, yyline);}
